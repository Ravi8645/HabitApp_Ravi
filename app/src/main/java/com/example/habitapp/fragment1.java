...
import com.example.habitapp.data.MyDbHandler;
...
public class fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        */
        ...
        //db.addHabit(new Habit("Quit smoking","To start saving money","21/12/2020"));
        //db.addHabit(new Habit("Start exercise","To get healthy","01/10/2021"));
        ...
        HabitAdapter adapter = new HabitAdapter(getActivity(), habits);
